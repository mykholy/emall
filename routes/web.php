...
Route::group(['middleware' => 'locale'], function () {
    ...
    Route::group(['middleware' => 'auth:admin', 'prefix' => '/admin'], function () {
        ...
        //Index
        Route::get('/gifts', 'Admin\GiftController@index')->name('admin.gifts.index');

        //Create
        Route::get('/gifts/create', 'Admin\GiftController@create')->name('admin.gifts.create');
        Route::post('/gifts', 'Admin\GiftController@store')->name('admin.gifts.store');

        //Read
        Route::get('/gifts/{id}', 'Admin\GiftController@show')->name('admin.gifts.show');

        //Update
        Route::get('/gifts/{id}/edit', 'Admin\GiftController@edit')->name('admin.gifts.edit');
        Route::patch('/gifts/{id}', 'Admin\GiftController@update')->name('admin.gifts.update');

        //Delete
        Route::delete('/gifts/{id}', 'Admin\GiftController@destroy')->name('admin.gifts.destroy');

        //Random_draw
        Route::get('/gifts/random_draw/{id}', 'Admin\GiftController@random_draw')->name('admin.gifts.random_draw');
